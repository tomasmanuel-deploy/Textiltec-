...
export default function Home() {
  ...
  const pieData = stats ? [
    { name: 'Success', value: (stats.totalSubmissions || 0) - (stats.errors || 0) },
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <h3 className="text-lg font-semibold mb-4 text-gray-800">Activity by Tenant</h3>
            <div className="h-80">
          ...
          {/* Status Distribution */}
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <h3 className="text-lg font-semibold mb-4 text-gray-800">Submission Status</h3>
                    ...
                    <tr key={tenant.fullId} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700 max-w-[100px]">
                          <div 
                            className={`h-2.5 rounded-full ${tenant.errors > 0 ? 'bg-yellow-400' : 'bg-green-600'}`} 
                            style={{ width: '95%' }}
                          ></div>
                        </div>
                      </td>
